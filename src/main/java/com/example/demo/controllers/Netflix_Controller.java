...
public class Netflix_Controller {
    ...
    @GetMapping(value = "/netflix/{Title}",
            produces = { "application/json", "application/xml" })
    public Netflix getCountry(@PathVariable String Title) {
    ...
    public ResponseEntity<Netflix> updateCountry(@Validated @RequestBody Netflix netflixDetails, @PathVariable String Title) {
    ...
    @PostMapping(value = "/netflix/create",
            produces = { "application/json", "application/xml" },
            consumes = { "application/json", "application/xml" })
    public ResponseEntity<Netflix> createNetflix(@RequestBody Netflix netflix) {
